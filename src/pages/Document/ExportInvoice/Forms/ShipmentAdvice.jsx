        ...
        <Card className="p-2 md:p-4 space-y-4">
            ...
            <form id="print-section" className="w-full max-w-4xl mx-auto text-black bg-white print:text-[12px]">
                ...
                <div className="border border-gray-400 p-6 print:p-4 text-[13px] print:text-[12px]">
                    <h1 className="text-center text-lg font-bold mb-6 uppercase underline">Shipment Advice</h1>
                    ...
                    <div className="grid grid-cols-2 gap-4 gap-y-3">
                        ...
                        <div className="col-span-2">
                            <TextArea label="Recipient Details" title="To:" />
                        </div>

                        <div className="col-span-2">
                            <TextArea label="Custom Text" title="Dear Sir," />
                        </div>

                        <div className="col-span-2 mt-4 mb-2">
                            <h2 className="font-bold text-center underline">Particulars of Shipment</h2>
                        </div>
