...
export default function CommercialInvoiceCollection() {
    return (
        <Card className="p-2 md:p-4 space-y-4">
            ...
            <form id="print-section" className="w-full max-w-4xl mx-auto text-black bg-white print:text-[12px]">
                ...
                <div className="border border-gray-400 p-6 print:p-4 text-[13px] print:text-[12px]">
                    <h1 className="text-center text-lg font-bold mb-6 uppercase underline">Commercial Invoice Collection</h1>
                    ...
                    <div className="grid grid-cols-2 gap-4 gap-y-3">
                        ...
                        <Field label="Container Number" type="text" />
                        <Field label="Seal No." type="text" />
                        <Field label="B/L No." type="text" />
                        <Field label="No. of Packaging" type="number" />
