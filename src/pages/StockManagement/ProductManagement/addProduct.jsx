...
export default function AddProduct() {
    ...
    const initialValues = {
        ...
        shipmentmanual: Array.isArray(data?.shipmentmanual) ? data.shipmentmanual : [],
        technicalSpecification: Array.isArray(data?.technicalSpecification) ? data.technicalSpecification : [],
        commercialAspect: Array.isArray(data?.commercialAspect) ? data.commercialAspect : [],
