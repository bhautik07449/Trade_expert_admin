...
const routes = (isLoggedIn) => [
  ...
  },
  {
    ...
    children: [
      ...
      {
        element: <AddAbcType />,
        path: "/website-management/content/abc-type/add",
        index: true,
      },
      {
        element: <AddAbcType />,
        path: "/website-management/content/abc-type/:id",
        index: true,
      },
      {
        element: <Abc />,
      ...
      },
      {
        ...
        path: "/market-development/process/add",
        index: true,
      },
      {
        element: <AddMarketDevelopment />,
        path: "/market-development/process/edit/:id",
        index: true,
      },
      {
        element: <MarketDevelopment />,
        path: "/market-development/process",
        index: true,
      },
      {
        element: <MarketData />,
